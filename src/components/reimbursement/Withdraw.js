...
export default class Withdraw extends React.Component {
  ...
  async withdraw() {
    ...
    await this.state.mainnetChain.reimbursementWalletWithdraw(
        schainName,
        amountWei,
        txOpts
    );
        ...
        return (
          <div className="fullscreen-msg">
              <div className="flex-container">
                ...
                <div className="flex-container fl-centered">
                  <h3 className='fullscreen-msg-text'>
                    Withdrawing from reimbursement wallet for {this.props.currentSchain}
                  </h3>
                </div>
              </div>
          </div>
          ...
          <Card>
            <CardContent>
              <h2 className='card-header'>
                Withdraw from reimbursement wallet
              </h2>
              ...
              <form noValidate autoComplete="off" className="marg-top-30">
                  ...
                  <SkBtnFilled size="large" className='marg-top-20' variant="contained" color="primary" onClick={this.withdraw}>
                    Withdraw
                  </SkBtnFilled>
              </form>
            </CardContent>
